        ...
        <div className="border-body-light bg-light rounded border p-8">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <div>
              ...
              <input type="password" minLength={1} id="newPassword" name="newPassword" className="border-body-light w-full rounded border px-4 py-2" required />
            </div>
            ...
            <div>
              ...
              <input type="password" id="confirmPassword" name="confirmPassword" className="border-body-light w-full rounded border px-4 py-2" required />
            </div>

            <button type="submit" disabled={loading} className="btn-primary-black mt-6">
              {loading ? "Validation..." : "Réinitialiser"}
            </button>
          </form>
        </div>
